...
ctx.keymap(
    {
        ...
        "slides menu [help]": Key("alt+/"),
        "menus ": Key("ctrl+shift+f"),
        "(previous | last) slide": Key("up"),
        "next slide": Key("down"),
        "first slide": Key("home"),
        "last slide": Key("end"),
        "slide up": Key("cmd+up"),
        "slide down": Key("cmd+down"),
        "move slide [to] beginning": Key("cmd+shift+up"),
        "move slide [to] end": Key("cmd+shift+down"),
        "select (previous | last) slide": Key("shift+up"),
        ...
        "open comment thread": Key("cmd+alt+shift+a"),
        "bold": Key("cmd+b"),
        "italic": Key("cmd+i"),
        "underline": Key("cmd+u"),
        "subscript": Key("cmd+,"),
        ...
        "enable screen reader": Key("alt+cmd+z"),
